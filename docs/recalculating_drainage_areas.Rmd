...
mapview(lshasta_clean, lwd=3) + 
    ...
    mapview(flowlines_streamriver, 
            #zcol="ftype",
            color="skyblue", 
            lwd=1.5, layer.name="Original Flowlines")
...
To account for change in drainage area in the *cleaned* Little Shasta, we can compare timing metrics from COMID=3917948 with the segment just upstream of the canal join (COMID=3917266), at COMID junction between 3917950 and 3917948. Use the timing from upstream segment (3917948) and propagate downstream. Does appear they are different.
