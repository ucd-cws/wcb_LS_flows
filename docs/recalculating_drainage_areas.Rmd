...
```{r printCleanMap1, eval=T, echo=F, out.width='100%'}

knitr::include_graphics(glue("{here()}/figs/map_of_h10_w_dem_overlay.png"))
...
## to do
 ...
 - include full H10 if catchment based
 - include Evan's spring streamline, but need to manually attribute 2.5 cfs to mainstem, since not surface/runoff based.
...
Make a map with:
 - HUC10
 - all NHDplus subcatchments
 - closed basin 'streams' in south of watershed
 - cleaned mainstem LShasta streamlines
 - Leland and Evans springs
 - contour lines?
